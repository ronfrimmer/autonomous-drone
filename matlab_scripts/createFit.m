...
% This function was automatically generated on 20-Oct-2022 15:53:10
...
[CdfF,CdfX] = ecdf(d,'Function','cdf');  % compute empirical cdf
BinInfo.rule = 1;
...
%     pd1 = ProbDistUnivParam('normal',[ 1.199279700132, 0.09137364204929])
pd1 = fitdist(d, 'normal');
YPlot = pdf(pd1,XGrid);
